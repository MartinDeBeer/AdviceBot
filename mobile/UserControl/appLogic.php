...
// connect to database
$db = mysqli_connect('localhost', 'root', '', 'advicebot');
...
if (isset($_POST['createUser'])){
    ...
    if(count($errors) == 0){        
      ...
      $results = mysqli_query($db, $createUser);
...
if (isset($_POST['reset-password'])) {
  ...
  if (count($errors) == 0) {
    ...
    $to = $email;
    $link = '<a href = "http://localhost/Advicebot2/UserControl/newPass.php?token=' . $token . '">link</a>';
